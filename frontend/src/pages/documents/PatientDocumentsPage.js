...
const PatientDocumentsPage = () => {
    ...
    // Define your API base URL for linking
    // Ensure REACT_APP_API_URL is correctly set in your .env file (e.g., http://localhost:5005/api)
                    ...
                    <ul style={styles.listContainer}>
                        {documents.map((doc) => (
                            <li key={doc._id} style={styles.listItem}>
                                ...
                                {/* ADDED: View Document Link */}
                                {doc.filePath && (
        <a
            // This is the core logic: take http://localhost:5005 from API_BASE_URL (by removing /api)
            // and append the correct /uploads/filename.ext from doc.filePath
...
const styles = {
    ...
    buttonHover: { // This style is defined but not directly used in button element. It's illustrative.
        backgroundColor: '#0056b3',
    },
    documentsListCard: {
        backgroundColor: 'white',
    ...
    // ADDED: New style for the View Document button/link
    viewButton: {
        ...
        fontWeight: 'bold',
        transition: 'background-color 0.3s ease',
        marginLeft: '15px', // Add some space from text
        whiteSpace: 'nowrap', // Prevent wrapping
        alignSelf: 'flex-end', // Align to bottom right if content wraps
    },
    viewButtonHover: { // Not directly used in inline style, but good practice
